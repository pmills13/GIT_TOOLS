# -*- coding: utf-8 -*-
"""
Created on Tue Jun 17 15:28:15 2025
...
##PCM: THINGS TO ADD
## 2) intergrate this script into the post_setup.py process. (just have it be imported))
## 3) add ability to save the convergence plots to a directory
...
def Create_Residual_Plots(rescale_file_dir):
  ...
  for i_case in range(nCases-1): ##NOTE: since nCases updates when writing cases data, nCases will be 1 more than the total number of cases, hence the -1
